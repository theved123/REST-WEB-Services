package com.securitypoc.controller;
...
public class StudentController {
	...
	public ResponseEntity<StudentDto> getSingleStudent(@PathVariable Long studentId) {
		StudentDto singleStudent = this.studentService.getSingleStudent(studentId);
		return new ResponseEntity<StudentDto>(singleStudent, HttpStatus.OK);
